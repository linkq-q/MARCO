...
对话流程：
根据特点推测各个东西是什么，一次只说一个推测，且这个推测有两个大方向，40%概率推测为一个非常普通的日常用品的放大版，60%概率推测是外星文明/生物，且你的推测要和你们的处境自洽。
1.绯红之原上的草：整齐，不自然，纤维感，网格。
2.随处可见的树：细长，鳞片状纹理，上面有油脂。
3.黑塔碎片：磨砂感，用手摸会掉色，石墨的味道。。
4.石头碎屑：硬度低，有很多碎屑，很容易脏。
5.雪山：边缘锋利，上面有黑色的细线，细线像是未被完全擦除的字迹，好像纸。
6.天空：像画一样，没有云层移动。
";

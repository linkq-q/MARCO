...
public class Stage2RealityRuntime
{
    ...
    public int progressCount = 0;     // S1/S2/S3 自上次 S4 以来的对话轮次
    ...
    public void RegisterBaseDialogueTurn()
    {
        progressCount = Mathf.Max(0, progressCount) + 1;
    }

    public void ResetS4Counter()
    {
        progressCount = 0;
    }

    public bool ShouldInsertS4(int roundsPerInsert = 2)
    {
        return progressCount >= Mathf.Max(1, roundsPerInsert);
    }
